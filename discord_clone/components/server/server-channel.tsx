...
export const ServerChannel = ({
    ...
    return (
        <button onClick={() => {}} className={cn(
            ...
            <p className={cn(
                "line-clamp-1 font-semibold text-sm textzinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:groupp-hover:text-zinc-300 transition",
            ...
            {channel.name === "general" && (
                <Lock className="hidden group-hover:block w-4 h-4 text-zinc-500 dark:text-zinc-400 ml-auto" />
            )}
        </button>
    )
}